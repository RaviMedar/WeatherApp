...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnAddFragment,
      @NonNull LinearLayout buttonLayout, @NonNull FrameLayout fragmentContainer,
      @NonNull Button getLocation) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, btnAddFragment, buttonLayout,
          fragmentContainer, getLocation);
    }
