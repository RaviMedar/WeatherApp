...
public final class DialogLayoutBinding implements ViewBinding {
  ...
  private DialogLayoutBinding(@NonNull LinearLayout rootView, @NonNull Button buttonCancel,
      @NonNull Button buttonSearch, @NonNull EditText editTextSearch) {
  ...
  public static DialogLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogLayoutBinding((LinearLayout) rootView, buttonCancel, buttonSearch,
          editTextSearch);
    }
